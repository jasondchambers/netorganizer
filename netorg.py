...
def main():
    ...
    group.add_argument("-d", "--devicetable", help="Export the device table", action="store_true")
    ...
    if args.configure:
        ...
        #TODO allow a DataFrame query string to be passed
        #TODO allow the columns to be specified
